...
namespace WoG.Characters.Services.Api.Migrations
{
    ...
    [Migration("20240412211328_Entity-ForeignKey")]
    partial class EntityForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WoG.Characters.Services.Api.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61ef6a6e-fa78-4ad6-8cf5-bafe973d4e7e"),
                        ...
                        new
                        {
                            Id = new Guid("7dd3a0c9-08f8-4607-96b8-452cc7682a1d"),
                        ...
                        new
                        {
                            Id = new Guid("2d06227d-1d7b-4a03-9f0b-b174f8098beb"),
                            BaseItemId = new Guid("fcb210e5-e63a-4c1b-b6c3-5040916eb2e7"),
                            BonusAgility = 5,
                            BonusFaith = 0,
                            BonusIntelligence = 0,
                        ...
                        new
                        {
                            Id = new Guid("27c6ba6a-4075-426f-aa14-d0e3957115a1"),
            ...
            modelBuilder.Entity("WoG.Characters.Services.Api.Models.Spell", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f62f6116-bab0-4f90-bef3-f2137bb4019e"),
                            BaseDamage = 12,
                            BaseHealing = 0,
                        ...
                        new
                        {
                            Id = new Guid("936110c3-81bb-45d8-bb2c-32e8aab4432f"),
                            BaseDamage = 0,
                            BaseHealing = 15,
